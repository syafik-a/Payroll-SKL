        ...
        <form action="{{ route('admin.karyawan.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" class="mt-1 block w-full p-2 border border-gray-300 rounded-md @error('gaji_pokok') border-red-500 @enderror" id="gaji_pokok" name="gaji_pokok" value="{{ old('gaji_pokok') }}" min="0" required>
                        @error('gaji_pokok')
                            <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>

...
<div class="bg-white shadow-md rounded-lg">
    <div class="p-6">
        <form action="{{ route('admin.karyawan.update', $karyawan) }}" method="POST">
            ...
            <h5 class="mb-4 text-lg font-bold">Data User</h5>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    <label for="password" class="block text-sm font-medium text-gray-700">Password <small class="text-gray-500">(Kosongkan jika tidak diubah)</small></label>
                    <input type="password" class="mt-1 block w-full p-2 border border-gray-300 rounded-md @error('password') border-red-500 @enderror" id="password" name="password">
                    @error('password')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="password" class="mt-1 block w-full p-2 border border-gray-300 rounded-md" id="password_confirmation" name="password_confirmation">
                </div>
            </div>

            <h5 class="mb-4 text-lg font-bold">Data Karyawan</h5>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>

...
<head>
    ...
    <style>
        ...
        .header h1 { margin: 0; }
        .info-table, .detail-table { width: 100%; margin-bottom: 20px; }
        .info-table td, .detail-table th, .detail-table td { padding: 5px 0; }
...
<body>
    <div class="container">
        ...
        <div class="text-center no-print mt-4">
            <button onclick="window.print()" class="bg-blue-600 text-white px-4 py-2 rounded-md">Cetak</button>
            <a href="{{ route('admin.gaji.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md">Kembali</a>
        </div>
    </div>
</body>
</html>